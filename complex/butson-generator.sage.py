...
# This file was *autogenerated* from the file Butson Type Complex Hadamard Matrices.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12)#type: ignore
...
if __name__ == "__main__":
    ...
    for d in range(_sage_const_2 , _sage_const_13 ):
        R = CyclotomicField(d)
        zeta = R.gen()
        ...
        for n in range(_sage_const_2 , _sage_const_12 ):
            run_parallel(n, d)
