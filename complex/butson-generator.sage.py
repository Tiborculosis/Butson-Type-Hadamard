...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_25 = Integer(25)#type: ignore
...
if __name__ == "__main__":
    ...
    for d in range(_sage_const_2 , _sage_const_25 ):
        R = CyclotomicField(d)
        zeta = R.gen()
        ...
        for n in range(_sage_const_2 , _sage_const_25 ):
