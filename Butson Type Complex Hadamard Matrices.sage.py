...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8)#type: ignore
...
if __name__ == "__main__":
    ...
    for d in range(_sage_const_2 , _sage_const_7 ):
        R = CyclotomicField(d)
        zeta = R.gen()
